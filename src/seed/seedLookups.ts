...
export async function seedLookups() {
  ...
  // Add-ons
  const addOns = [
    { code: "URGENT", name: "Яаралтай", priceType: "PERCENT" as const, priceValue: 20 },
    { code: "NIGHT", name: "Шөнө/ажлын бус цаг", priceType: "PERCENT" as const, priceValue: 15 },
    { code: "MULTI_POINT", name: "Олон цэг", priceType: "FIXED" as const, priceValue: 10000 },
  ];
