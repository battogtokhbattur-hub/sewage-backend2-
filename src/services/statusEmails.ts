...
/* ══════════════════════════════════════════════════
   1) CONFIRMED — "Захиалга баталгаажлаа" имэйл
══════════════════════════════════════════════════ */
...
/* ══════════════════════════════════════════════════
   2) ASSIGNED — "Жолооч хувиарлагдлаа" имэйл
══════════════════════════════════════════════════ */
export interface AssignedEmailPayload extends StatusEmailPayload {
  driverName:  string;
  driverPhone: string;
  truckName?:  string;     // "Hyundai HD78"
  truckPlate?: string;     // "УБА-1234"
}
...
/* ══════════════════════════════════════════════════
   4) AWAITING_PAYMENT — НЭХЭМЖЛЭЛ имэйл
   (үйлчилгээ дууссан, төлбөр хүлээж байна)
══════════════════════════════════════════════════ */
...
/* ══════════════════════════════════════════════════
   5) DONE — "Захиалга бүрэн дууслаа" имэйл (төлбөр төлөгдсөний дараа)
══════════════════════════════════════════════════ */
...
/* ══════════════════════════════════════════════════
   7) ADMIN — "Хэрэглэгч төлсөн" гэж мэдэгдэх имэйл
══════════════════════════════════════════════════ */
